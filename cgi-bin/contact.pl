...
%files = (
    'default',  '/home/charlie/www.ravepictures.net/oneliner/contactme_default_incl.shtml'
...
# --------- Archiving --------------
    ...
    %archives = (
        'another',  '../oneliner/archive_incl.shtml',
        'default',  '../oneliners_archive_incl.shtml'
        # If modifying, note the missing comma on the last line (the one above this line)
    );
...
# --------- Customize look ---------
    ...
    $font_date = '<font face="tahoma, verdana, arial, geneva" size=1 color="#4FE59D"><BR>';

    # Font tag to use for the actual message
    $font_msg  = '<font face="tahoma, verdana, arial, geneva" size=1 color="#FFFFFF"><BR>';

    # Font tag to use for the nickname
    $font_who  = '<font face="tahoma, verdana, arial, geneva" size=1 color="#EF80EF"><BR>';
...
sub getEntry {
    ...
    $text .= '<td align=right nowrap>' . $font_who . $in{'who'} . '</font></td><BR><P>';
    $text .= "</tr>\n";
}
